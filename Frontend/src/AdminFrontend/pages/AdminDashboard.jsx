            ...
            <div className="relative flex flex-col overflow-hidden rounded-[1.75rem] text-white">
              ...
              <div className="relative mt-auto p-6">
                ...
                <button
                  ...
                  className="mt-5 flex w-full items-center justify-center gap-2 rounded-full bg-apricot-400 px-5 py-3 text-sm font-bold text-emerald-950 transition-colors hover:bg-apricot-300"
                >
