...
const userAuthRoutes = require("./LocalGuidePannel/routes/authRoutes"); // Add this line for user routes
...
app.use("/api/user/auth", userAuthRoutes); // Add this line to handle user authentication routes
